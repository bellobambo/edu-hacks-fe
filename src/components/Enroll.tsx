...
export default function Enroll({ courses }: EnrollProps) {
  ...
  return (
    <main className="max-w-md mx-auto p-6 bg-[#744253] rounded-lg shadow-md mb-6">
      <h1 className="text-2xl font-bold mb-4 text-[#B49286]">
        Enroll In Course
      </h1>

      <div className="mb-3">
        <label htmlFor="course-select" className="block mb-2 text-[#B49286]">
          Select Course:
        </label>
        <select
          id="course-select"
          ...
          className="border border-[#B49286]/20 p-2 w-full rounded bg-[#744253] text-[#B49286]"
        >
      ...
      <button
        ...
        onClick={enroll}
        className="bg-[#B49286] hover:bg-[#B49286]/90 text-[#744253] px-4 py-2 rounded disabled:opacity-50 transition-colors"
      >
